...
plt.title("Comparison of float and double precision on CPU and GPU, Kokkos::LayoutLeft")
...
plt.title("Comparison of float and double precision on CPU and GPU, Kokkos::LayoutRight")
...
plt.title("Time comparison of float and double precision on CPU and GPU, Kokkos::LayoutLeft")
plt.savefig("TL.png")
...
plt.title("Time comparison of float and double precision on CPU and GPU, Kokkos::LayoutRight")
plt.savefig("TR.png")
